let buttonSalva = document.getElementById('salvaBtm');
buttonSalva.addEventListener('click', add);
var num = 0

function add() {
    let table = document.getElementById("tableAdd")
    let impegno = document.getElementById("impegno-testo").value 
    let importanza = document.getElementById("importanza-select").value
